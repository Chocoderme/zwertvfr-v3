<template>
  <textarea v-model="value" :rows="rows" :cols="cols" :minlength="minlength" :maxlength="maxlength"
    :autocomplete="autocomplete" :placeholder="placeholder" :aria-required="required" :required="required"
    :disabled="disabled" />
</template>
